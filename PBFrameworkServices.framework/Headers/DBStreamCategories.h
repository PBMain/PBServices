...
// Insert
+(void) insertStreamCategories:(NSArray*)categories streamID:(NSString*)streamID isLocation:(BOOL)isLocation;
+(void) insertStreamCategoryAssets:(NSArray*)assets streamID:(NSString*)streamID categoryID:(NSString*)categoryID;
